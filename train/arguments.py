...
parser = argparse.ArgumentParser(description='Bigtwo: PyTorch chudadi AI')

# General Settings
parser.add_argument('--xpid', default='bigtwo',
                    help='Experiment id (default: bigtwo)')
...
parser.add_argument('--savedir', default='bigtwo_checkpoints',
...
parser.add_argument('--num_buffers', default=100, type=int,
